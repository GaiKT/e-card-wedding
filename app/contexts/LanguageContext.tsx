...
const translations = {
  ...
  th: {
    ...
    "story.firstMeetDesc":
      "เราเจอกันครั้งแรกในเช้าวันเกิดของเธอ หลังจากที่เรารู้จักกันทาง Facebook ผมตั้งใจนำของขวัญวันเกิดไปให้เธอที่บ้าน การเจอกันครั้งนั้นทำผมเขินเอามากๆ และเราก็เริ่มคบกันจนความสัมพันธ์ของเราดีขึ้นเรื่อยๆ จนกลายเป็นความรักในที่สุด",
    ...
    "story.proposalDesc":
      "หลังจากที่เราคบกันมาได้ 9 ปี เราสองคนปรับตัวเข้าหากันและคอยปรับปรุงดูแลความสัมพันธ์มาโดยตลอด จนในที่สุดก็ถึงวันที่ผมขอเธอแต่งงานที่บ้านของเธอ มีการเซอร์ไพรส์เล็กๆ น้อยๆ ตามสไตล์ introvert แบบเรา และเธอก็ตอบตกลงด้วยความสุขใจ",
