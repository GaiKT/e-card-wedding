...
const translations = {
  ...
  th: {
    ...
    "story.firstMeetDesc":
      "เราเจอกันครั้งแรกในเช้าวันเกิดของเธอ หลังจากที่เรารู้จักกันทาง Facebook ผมตั้งใจนำของขวัญวันเกิดไปให้เธอที่บ้าน และการเจอครั้งนั้นผมเขินมากๆ เริ่มคบกันและความสัมพันธ์ของเราดีขึ้นเรื่อยๆ จนกลายเป็นความรักในที่สุด",
